...
const clientstart = async() => {
    ...
    if (config().status.terminal && !sock.authState.creds.registered) {
        const phoneNumber = await question('enter your WhatsApp number, for example 256701583113:\nnumber WhatsApp: ');
        ...
        if (connection === 'open') {
            ...
            sock.sendMessage(botNumber, {
                text:
                    ...
                    `> 🤖 Version: 1.0.0\n` +
                    `> 👑 Owner: 𝚁𝙸𝙿𝙿𝙻𝙴 𝚂𝚃𝙴𝙼 𝙻𝙰𝙱𝚂\n\n` +
                    `✅ Bot connected successfully\n` +
                    `📢 Join our channel: https://whatsapp.com/channel/0029VbBhe8lCRs1fCxZ9OM3U`,
                contextInfo: {
                    forwardingScore: 1,
                    isForwarded: true,
                    externalAdReply: {
